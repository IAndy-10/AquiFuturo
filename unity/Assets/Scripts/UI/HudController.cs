...
namespace AquiFuturo.UI
{
    ...
    public sealed class HudController : MonoBehaviour
    {
        ...
        [Header("Prompts")]
        [SerializeField] private GameObject _scanPrompt;
        ...
        {
            SetActive(_scanPrompt,    state == AppState.Scanning);
            SetActive(_placePrompt,   state == AppState.Placing || state == AppState.PlacingFallback);
