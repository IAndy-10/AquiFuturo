...
namespace AquiFuturo.Core
{
    ...
    {
        [Header("Scanning")]
        [Tooltip("Seconds to scan for planes before switching to fallback placement.")]
        public float scanTimeoutSeconds = 20f;

        [Tooltip("Minimum plane area in m² required to accept a plane for placement.")]
        public float minPlaneAreaSqM = 1f;
